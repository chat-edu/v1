...
export const studyGuideResponseDescription = 'Study guides should SUMMARIZE the notes and should only include the most important information. Study guides must be in markdown and should use heading 1s (#), 2s (##), and 3s (###), and bullet points (-) to organize the content.';
